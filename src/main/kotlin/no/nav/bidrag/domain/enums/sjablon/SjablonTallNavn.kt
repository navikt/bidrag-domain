...
enum class SjablonTallNavn(
    ...
    BOUTGIFTER_BIDRAGSBARN_BELOP("BoutgifterBidragsbarnBeløp", "0003", false, false, true, false, false, false, false, false),
    FORDEL_SKATTEKLASSE2_BELOP("FordelSkatteklasse2Beløp", "0004", true, false, false, true, false, false, true, false),
    FORSKUDDSSATS_BELOP("ForskuddssatsBeløp", "0005", false, false, false, true, false, true, true, false),
    INNSLAG_KAPITALINNTEKT_BELOP("InnslagKapitalInntektBeløp", "0006", false, false, false, false, false, false, false, false),
    INNTEKTSINTERVALL_TILLEGGSBIDRAG_BELOP("InntektsintervallTilleggsbidragBeløp", "0007", false, false, false, false, false, false, false, false),
    MAKS_INNTEKT_BP_PROSENT("MaksInntektBPProsent", "0008", false, false, false, false, false, false, false, false),
    HOY_INNTEKT_BP_MULTIPLIKATOR("HøyInntektBPMultiplikator", "0009", false, false, false, false, false, false, false, false),
    ...
    NEDRE_INNTEKTSGRENSE_GEBYR_BELOP("NedreInntektsgrenseGebyrBeløp", "0014", false, false, false, false, false, false, false, false),
    ...
    UNDERHOLD_EGNE_BARN_I_HUSSTAND_BELOP("UnderholdEgneBarnIHusstandBeløp", "0019", true, false, false, false, false, false, false, false),
    ENDRING_BIDRAG_GRENSE_PROSENT("EndringBidragGrenseProsent", "0020", false, false, false, false, false, false, false, false),
    BARNETILLEGG_FORSVARET_FORSTE_BARN_BELOP("BarnetilleggForsvaretFørsteBarnBeløp", "0021", false, false, false, false, true, false, false, false),
    BARNETILLEGG_FORSVARET_OVRIGE_BARN_BELOP("BarnetilleggForsvaretØvrigeBarnBeløp", "0022", false, false, false, false, true, false, false, false),
    MINSTEFRADRAG_INNTEKT_BELOP("MinstefradragInntektBeløp", "0023", true, false, false, false, false, false, false, false),
    GJENNOMSNITT_VIRKEDAGER_PR_MAANED_ANTALL("GjennomsnittVirkedagerPrMånedAntall", "0024", false, false, false, false, false, false, false, false),
    MINSTEFRADRAG_INNTEKT_PROSENT("MinstefradragInntektProsent", "0025", true, false, false, false, false, false, false, false),
    DAGLIG_SATS_BARNETILLEGG_BELOP("DagligSatsBarnetilleggBeløp", "0026", false, false, false, false, false, false, false, false),
    PERSONFRADRAG_KLASSE1_BELOP("PersonfradragKlasse1Beløp", "0027", true, false, false, false, false, false, false, false),
    PERSONFRADRAG_KLASSE2_BELOP("PersonfradragKlasse2Beløp", "0028", true, false, false, false, false, false, false, false),
    KONTANTSTOTTE_BELOP("KontantstøtteBeløp", "0029", false, false, false, false, false, false, false, false),
    OVRE_INNTEKTSGRENSE_IKKE_I_SKATTEPOSISJON_BELOP("ØvreInntektsgrenseIkkeISkatteposisjonBeløp", "0030", false, false, false, true, false, false, true, false),
    NEDRE_INNTEKTSGRENSE_FULL_SKATTEPOSISJON_BELOP("NedreInntektsgrenseFullSkatteposisjonBeløp", "0031", false, false, false, true, false, false, true, false),
    EKSTRA_SMAABARNSTILLEGG_BELOP("EkstraSmåbarnstilleggBeløp", "0032", false, false, false, false, false, false, false, false),
    OVRE_INNTEKTSGRENSE_FULLT_FORSKUDD_BELOP("ØvreInntektsgrenseFulltForskuddBeløp", "0033", false, false, false, false, false, true, false, false),
    OVRE_INNTEKTSGRENSE_75PROSENT_FORSKUDD_EN_BELOP("ØvreInntektsgrense75ProsentForskuddEnBeløp", "0034", false, false, false, false, false, true, false, false),
